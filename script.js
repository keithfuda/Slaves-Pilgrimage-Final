...
const bossPowerups = [
    {
        ...
        image: "chineseTakeout.png",
        icon: "chineseTakeoutIcon.png",
        action: "heal"
    },
    {
        name: "White Powder",
        image: "whitePowder.png",
        icon: "whitePowderIcon.png",
        action: "speed"
    },
    {
        name: "Cigarette Pack",
        image: "cigPack.png",
        icon: "cigPackIcon.png",
        action: "attack"
    }
];
...
player.image.src = "spritesheet.png"; // Make sure the file path is correct
...
enemySprites.eye.src = "eye_Spritesheet.png";
enemySprites.cat.src = "cat_Spritesheet.png";
enemySprites.meatman.src = "meatman_Spritesheet.png";
enemySprites.boss.src = "boss.png";
...
heartImage.src = "heart.png"; // Full heart image

const halfHeartImage = new Image();
halfHeartImage.src = "halfheart.png"; // Half-heart image

const emptyHeartImage = new Image();
emptyHeartImage.src = "emptyHeart.png"; // Half-heart image

const bulletImage = new Image();
bulletImage.src = "bullet.png"; 

const enemyBulletImageV1 = new Image();
enemyBulletImageV1.src = "enemyBullet.png";

const enemyBulletImageV2 = new Image();
enemyBulletImageV2.src = "enemyBulletV2.png";

const ENEMY_BULLET_DAMAGE_V1 = .5;   // or enemy.damage
const ENEMY_BULLET_DAMAGE_V2 = .5;

const audio = new Audio("pistol.mp3");
const catSpawnSound = new Audio("catSpawn.mp3");
const eyeSpawnSound = new Audio("eyeSpawn.mp3");
const meatmanSpawnSound = new Audio("meatmanSpawn.mp3");

const catDeathSound = new Audio("catDeath.mp3");
const eyeDeathSound = new Audio("eyeDeath.mp3");
const meatmanDeathSound = new Audio("meatmanDeath.mp3");
...
const powerupImages = {
    "chineseTakeout.png": new Image(),
    "whitePowder.png": new Image(),
    "cigPack.png": new Image(),
    "catPaws.png": new Image()
  };
  
  powerupImages["chineseTakeout.png"].src = "chineseTakeout.png";
  powerupImages["whitePowder.png"].src = "whitePowder.png";
  powerupImages["cigPack.png"].src = "cigPack.png";
  powerupImages["catPaws.png"].src = "catPaws.png";
...
allEnemySounds.forEach(sound => {
    ...
    let newMap = `x${currentX}y${currentY}.png`;
